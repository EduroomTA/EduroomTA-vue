...
!(function (A, e) {
                                ...
                                if (o(f, 0) === A) {
                                    for (var l = f.byteLength, c = 2; c < l; ) {
                                        ...
                                        if (((c += 2), g === e)) {
                                            ...
                                            var v = o(f, c, s);
                                            c += 2;
                                            for (var w = 0; w < v; w++) if (o(f, c + 12 * w, s) === i) return void d(o(f, c + 12 * w + 8, s));
                                        } else {
                                            if ((g & r) !== r) break;
                                            c += o(f, c);
                                        }
    ...
    return "undefined" != typeof window && void 0 !== window.document && document.dispatchEvent(new CustomEvent("FilePond:pluginloaded", { detail: l })), l;
});
