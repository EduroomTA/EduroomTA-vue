            ...
            return e.utils.createView({
                ...
                write: function (e) {
                    ...
                    var u = { x: 0, y: 0, width: s, height: h, center: { x: 0.5 * s, y: 0.5 * h } },
                        ...
                        E = a.zoom * y;
                    n && n.length
                        ? (t.ref.createMarkup(), (t.ref.markup.width = s), (t.ref.markup.height = h), (t.ref.markup.resize = o), (t.ref.markup.dirty = c), (t.ref.markup.markup = n), (t.ref.markup.crop = C(l, a)))
            ...
            self.onmessage = function (e) {
                for (
                    ...
                    (A = r[T] / 255),
                        ...
                        (r[T + 1] = Math.max(0, Math.min(255 * (A * u + R * l + P * d + C * f + g), 255))),
                        (r[T + 2] = Math.max(0, Math.min(255 * (A * p + R * m + P * y + C * E + v), 255))),
        ...
        q = function (e) {
            var t = e.utils.createView({
                    ...
                    create: function (e) {
                        var t = e.root,
                            i = e.props;
                        !V && document.querySelector("base") && ((G = G.replace(/url\(\#/g, "url(" + window.location.href.replace(window.location.hash, "") + "#")), (V = !0)),
                            O++,
                                                ...
                                                !(function (e) {
                                                    ...
                                                    if (r) {
                                                        ...
                                                        (a.crop = r.getMetadata("crop")),
                                                            ...
                                                            t.query("GET_IMAGE_PREVIEW_MARKUP_SHOW") && ((a.dirty = !0), (a.resize = r.getMetadata("resize")), (a.markup = r.getMetadata("markup")));
                                                    }
                                                })({ root: t, props: i });
                                        }
                                        var l, d;
