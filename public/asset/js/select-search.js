...
;(function ($) {
    ...
    _createClass(FormSelect, [{
      ...
      value: function _setupDropdown() {
		...
		if (this.searchable) {
			...
			var element = $('<div class="input-select-search"><input placeholder="Search Here" type="text" class="dropDownsearch"></div>');
      ...
      value: function _appendOptionWithIcon(select, option, type) {
        ...
        var multipleCheckbox = this.isMultiple ? "<label class='matter-checkbox'><input type=\"checkbox\"" + disabledClass + "\"/><span>" + option.innerHTML + "</span></label>" : option.innerHTML;
        var liEl = $('<li></li>');
  ...
  if (M.jQueryLoaded) {
    M.initializeJqueryWrapper(FormSelect, 'formSelect2', 'M_FormSelect');
  }
})(cash);
;(function ($, anim) {
  'use strict';
