						...
						<nav class="nav-dash in-scroll-page">
							<div class="container w60">
								<div class="nav-wrapper">
									...
									<ul class="nav-right">
										<router-link tag="li" :to="{ name: 'guru.kelas.mapel.tugas.kuis.detail' }">
											<a class="primary-text" href="">Kuis</a>
											<div class="nav-actives"></div>
										</router-link>
										<router-link tag="li" :to="{ name: 'guru.kelas.mapel.tugas.kuis.rekap' }">
					...
					<div class="title">
						...
						<div class="row nm">
							...
							<div class="col s12 m12 l6 right-align-res">
								<p class="normal dark7-text">
									<span class="badge-text1 primary white-text">Tenggat 12 Juni, 13:00</span>
								</p>
							</div>
						</div>
					</div>
				...
				<div v-else>
					<table>
						<thead>
							<tr>
								<th>
									<a @click="sortUser('nama')" class="matter-button-text button-icon" content="Urutkan Berdasarkan Nama" v-tippy='{ placement : "bottom" }'>
										<i 
								...
								<th>
									<a @click="sortUser('deskripsi')" class="matter-button-text button-icon" content="Urutkan Berdasarkan Status" v-tippy='{ placement : "bottom" }'>
										<i 
								...
								<th>
									<a @click="sortUser('jumlah')" class="matter-button-text button-icon" content="Urutkan Berdasarkan Nilai" v-tippy='{ placement : "bottom" }'>
										<i 
	...
	export default {
		...
		computed: {
			filteredUsers: function(){
				return this.searchUsersByNama(this.filterUsersByStatus(this.sortUserAction(this.users)))
			},
		},
		methods: {
