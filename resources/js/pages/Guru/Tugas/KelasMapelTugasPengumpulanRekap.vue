						...
						<nav class="nav-dash in-scroll-page">
							<div class="container w60">
								<div class="nav-wrapper">
									...
									<ul class="nav-right">
										<router-link tag="li" :to="{ name: 'guru.kelas.mapel.tugas.pengumpulan.detail' }">
											<a class="primary-text" href="">Tugas</a>
											<div class="nav-actives"></div>
										</router-link>
										
										<router-link tag="li" :to="{ name: 'guru.kelas.mapel.tugas.pengumpulan.rekap' }">
					...
					<table>
						...
						<tbody>
							...
							<tr v-for="user in filteredUsers">
								...
								<td class="center">{{ user.jumlah }}</td>
								<td class="right-align">
									...
									<div v-else>
										<router-link 
										:to="{ name: 'guru.kelas.mapel.tugas.pengumpulan.jawaban', params: { id: user.id} }" 
	...
	export default {
		...
		computed: {
			filteredUsers: function(){
				return this.filteredUsersByNama(
					this.filteredUsersByStatus(
						this.filteredUsersByShortNama(this.users)
						)
					)
			},
		},
