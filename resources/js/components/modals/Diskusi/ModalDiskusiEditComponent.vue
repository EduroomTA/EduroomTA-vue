<template>
	<section>
		...
		<div id="modal-edit-diskusi" class="modal modal-full modal-fixed-header">
			<div class="modal-header row nm">
				<div class="col s7">
					<h5 class="title-modal">Edit Diskusi</h5>
				</div>
			...
			<div class="modal-content">
				<div class="row">
					<div class="col s12 m12 l9 mb1-res">
						<div class="row">
							<div class="col s12">
								<label id="judul" class="matter-textfield-filled" style="width: 100%">
									<input 
									type="text" 
									v-model="diskusi.judul"  
									placeholder=" "/>
					...
					<div class="col s12 m12 l3">
						...
						<div class="row">
							<div class="col s12">
								<label id="select_standared" class="matter-textfield-flat center-select select-flat" style="width: 100%">
									...
									required="true" 
									aria-required="true" 
									v-model="diskusi.id_sub_penilaian">
						...
						<div class="row">
							...
							<div class="col s6">
								<date-picker 
								v-model="diskusi.deadline_tanggal" 
								valueType="format" 
								placeholder="Tanggal">
							...
							<div class="col s6">
								<date-picker
								v-model="diskusi.deadline_waktu"
								format="HH:mm"
								value-type="format"
								type="time"
								placeholder="Waktu"
						...
						<div id="penjadwalan_edit_diskusi_layout" class="row hide">
							...
							<div class="col s6">
								<date-picker 
								v-model="diskusi.jadwal_penerbitan_tanggal"
								valueType="format" 
								placeholder="Tanggal">
								<svg slot="icon-calendar"></svg></date-picker>
							</div>
							...
							<div class="col s6">
								<date-picker
								v-model="diskusi.jadwal_penerbitan_waktu"
								format="HH:mm"
								value-type="format"
								type="time"
								placeholder="Waktu"
	...
	export default {
		...
		mounted() {
			$('#penjadwalan_diskusi_edit').click(function () {
				$('#penjadwalan_edit_diskusi_layout')
				.toggleClass("hide", !$("#penjadwalan_diskusi_edit")
					.prop("checked")); 
			});
		},
		methods: {
