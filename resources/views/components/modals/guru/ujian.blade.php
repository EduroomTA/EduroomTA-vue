{{-- MODAL TUGAS PILGAN DETAIL --}}

{{-- ADD SOAL PILGAN --}}
<div id="modal-add-soal" class="modal modal-full">
      ...
      <form action="" method="POST">
        ...
        <div class="row">
          ...
          <div class="col s8 m4 l4">
            <label id="select_standared" class="matter-textfield-flat select-flat" style="width: 100%">
              <select id="pilihan_type_jawaban" class="validate" required="true" aria-required="true" name="kunci">
                <option value="" disabled selected>Pilih Jawaban</option>
                <option value="true_false">True Flase</option>
        ...
        <div id="soal_pilgans" class="hide">
          <div class="row">
            <div class="col s12">
        ...
        <div id="soal_trufalses" class="hide">
          <div class="row type-rows card outlined noborder hoverable-shadow-nb">
            <div class="card-header row">
              <div class="title col s11">
...
{{-- LIHAT KUNCI --}}
<div id="modal-kunci" class="modal modal-full">
  ...
  <div class="modal-content">
    <div class="container w60">
      <div class="row">
        ...
        <div class="col s12">
          <h5 class="primary-text semibold">Kunci Jawaban</h5>
        </div>
        <div class="col s12">
          <div class="row">
            <div class="col s12 m12 l3 center">
              <h3 class="semibold primary-text mtb1">A</h3>
            </div>
