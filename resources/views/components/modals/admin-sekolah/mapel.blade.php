...
{{-- DELETE --}}
<div id="modal-delete-mapel" class="modal modal-small">
	<div class="modal-content">
		<h6 class="bold">Hapus Mapel</h6>
		<p>Anda akan menghapus Mapel ...</p>
	</div>
...
{{-- EDIT --}}
<div id="modal-edit-mapel" class="modal modal-small initial">
