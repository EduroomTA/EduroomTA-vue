			...
			<div class="row nm">
				<div class="col s12 m12 l6">
					<div class="left-align-res">
						<h5 class="semibold nm mb2-res0">Nama Gurunya</h5>
					</div>
				</div>
				<div class="col s12 m12 l6">
					<div class="row nm">
						<div class="col s12">
							<ul class="tabs small-land indicatorv2 inline">
								...
								<li class="tab col s4"><a href="#kelas_wali">Kelas Wali</a></li>
								<li class="tab col s4"><a href="#kelas_ajar">Kelas Ajar</a></li>
							</ul>
						</div>
					</div>
				</div>
		...
		<table class="highlight">
			<tbody>
				...
				<tr>
					...
					<td>
						<div class="right-align">
							<a id="btn_nip" class="matter-button-text modal-trigger" href="#modal-edit">Edit</a>
						</div>
					</td>
				</tr>
				<tr>
...
<section id="kelas_wali" class="container w50">
	<table>
		<thead>
			<tr>
				<th>Kelas</th>
		...
		<tbody>
			<tr>
				<td>
					<a class="matter-button-text" href="{{route('admin-sekolah.kelas.detail')}}" target="_blank">8C</a>
				</td>
				<td>
					2020/2021
				</td>
...
<section id="kelas_ajar" class="container w50">
	<table>
		<thead>
			<tr>
				<th>Kelas</th>
