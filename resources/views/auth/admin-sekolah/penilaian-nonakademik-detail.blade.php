			...
			<div class="row nm">
				<div class="col s12 m12 l6">
					<div class="left-align-res">
						<h5 class="normal primary-text nm">Non Akademik<i class="material-icons line-icon-p">stop_circle</i><span style="font-size: 1rem">2020/2021</span></h5>
					</div>
				</div>
				<div class="col s12 m12 l6">
					<div class="row nm">
						<div class="col s12">
							<ul class="tabs small-land indicatorv2 inline">
								...
								<li class="tab col s4"><a href="#spiritual">Spiritual</a></li>
								<li class="tab col s4"><a href="#sosial">Sosial</a></li>
							</ul>
						</div>
					</div>
				</div>
...
<section id="spiritual" class="container w60 mb5">
	<table>
		<thead>
			<tr>
...
<section id="sosial" class="container w60">
	<table>
		<thead>
			<tr>
				<th>Komponen Penilaian</th>
